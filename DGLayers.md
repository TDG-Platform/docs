...
* To indicate that the recipe file and any auxiliary files that it points to should be copied to output LOGS sub-directory: place the tag, WRITE_RECIPE_FILE_TO_OUTPUT, prior to the command sequence
