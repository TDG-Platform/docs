...
- [Known Issues](#known-issues) - Best Orthorectification Options for WorkdView Imagery
...
### Known Issues:  
 Not recommended for use with WorldView (Includes WV01, WV02, WV03)or QuickBird level 1B imagery.  See background information for details on RPCOrthorectification limitations.  For WorldView imagery, Orthorectification using the [Advanced Image Preprocessor](https://github.com/TDG-Platform/docs/blob/master/Advanced_Image_Preprocessor.md) is recommended.
