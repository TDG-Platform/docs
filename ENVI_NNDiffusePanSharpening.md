...
--------|:----------:|-----------|----------------|---------------
output_raster_uri   |  YES  | None  | string  | Specify a string with the fully qualified filename and path of the output raster. If you do not specify this property, the output raster is only temporary. Once the raster has no remaining references, ENVI deletes the temporary file.
